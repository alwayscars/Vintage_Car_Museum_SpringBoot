    ...
    const fetchCars = async () => {
      try {
        const response = await axios.get(
          "https://dj6xr77s-8080.inc1.devtunnels.ms/cars/year/2010s"
        );
    ...
    <div className="fifties-container">
      ...
      <div className="fifties-wrapper">
        <div className="header-section">
          <h1 className="main-title">2010's</h1>
        ...
        <div className="fifties-card">
          ...
          {!loading && !error && cars.length === 0 && (
            <div className="empty-state">
              <p>No cars found from the 2010's</p>
            </div>
          )}
